...
const _translations = <String, _Translation>{
  ...
  'No active bookings.': _Translation(
    'Tiada tempahan aktif.',
    '没有进行中的预订。',
    '進行中の予約はありません。',
    '진행 중인 예약이 없습니다.',
  ),
  'No past bookings.': _Translation(
    'Tiada tempahan lepas.',
    '没有过往预订。',
    '過去の予約はありません。',
    '지난 예약이 없습니다.',
  ),
  'No cancelled bookings.': _Translation(
    'Tiada tempahan dibatalkan.',
    '没有已取消的预订。',
    'キャンセルされた予約はありません。',
    '취소된 예약이 없습니다.',
  ),
  'Unable to refresh bookings. The displayed status may be out of date.':
      _Translation(
        'Tidak dapat memuat semula tempahan. Status mungkin tidak terkini.',
        '无法刷新预订，显示的状态可能不是最新。',
        '予約を更新できません。表示される状態は最新でない場合があります。',
        '예약을 새로고침할 수 없습니다. 표시된 상태가 최신이 아닐 수 있습니다.',
      ),
  ...
  'Search attractions': _Translation(
    'Cari tarikan',
    '搜索景点',
    '観光地を検索',
    '관광지 검색',
  ),
  'Retry loading home': _Translation(
    'Cuba muat semula halaman utama',
    '重新加载首页',
    'ホームを再読み込み',
    '홈 다시 불러오기',
  ),
  'Explore Penang': _Translation(
    'Terokai Pulau Pinang',
    '探索槟城',
    'ペナンを探索',
    '페낭 둘러보기',
  ),
  'Near': _Translation('Berdekatan', '靠近', '付近', '근처'),
  'Where will you go next?': _Translation(
    'Ke manakah anda seterusnya?',
    '下一站想去哪里？',
    '次はどこへ行きますか？',
    '다음에는 어디로 갈까요?',
  ),
  'Search attractions and locations': _Translation(
    'Cari tarikan dan lokasi',
    '搜索景点和地点',
    '観光地と場所を検索',
    '관광지와 장소 검색',
  ),
  ...
  'Based on your preferences, visits and budget': _Translation(
    'Berdasarkan pilihan, lawatan dan bajet anda',
    '根据你的偏好、访问记录和预算',
    '好み、訪問履歴、予算に基づく',
    '선호도, 방문 기록 및 예산 기준',
  ),
  'Highly rated': _Translation('Dinilai tinggi', '高评分景点', '高評価', '높은 평점'),
  'Aggregate ratings from completed visits': _Translation(
    'Penilaian daripada lawatan yang selesai',
    '来自已完成访问的综合评分',
    '完了した訪問の総合評価',
    '완료된 방문의 종합 평점',
  ),
  'Quieter choices': _Translation(
    'Pilihan lebih tenang',
    '较少拥挤的选择',
    'より静かな選択肢',
    '한산한 선택지',
  ),
  'Lower live crowd with future slots': _Translation(
    'Orang ramai lebih rendah dengan slot akan datang',
    '人流较少且有未来时段',
    '混雑が少なく今後の時間枠がある',
    '혼잡도가 낮고 향후 시간대가 있는 곳',
  ),
  'Plan or discover an itinerary': _Translation(
    'Rancang atau terokai itinerari',
    '规划或探索行程',
    '旅程を計画または探索',
    '일정 계획 또는 탐색',
  ),
  'No matching attractions available yet.': _Translation(
    'Tiada tarikan sepadan buat masa ini.',
    '暂时没有匹配的景点。',
    '一致する観光地はまだありません。',
    '일치하는 관광지가 아직 없습니다.',
  ),
  ...
  'No approved attractions match your current search or filters.': _Translation(
    'Tiada tarikan diluluskan sepadan dengan carian atau penapis anda.',
    '没有已批准景点符合你的搜索或筛选条件。',
    '検索またはフィルターに一致する承認済み観光地はありません。',
    '현재 검색 또는 필터와 일치하는 승인된 관광지가 없습니다.',
  ),
  ...
  'Minimum visitor rating': _Translation(
    'Penilaian minimum pelawat',
    '最低访客评分',
    '最低訪問者評価',
    '최소 방문객 평점',
  ),
  'Any rating': _Translation('Sebarang penilaian', '任何评分', 'すべての評価', '모든 평점'),
  '3.0 and above': _Translation(
    '3.0 dan ke atas',
    '3.0 及以上',
    '3.0以上',
    '3.0 이상',
  ),
  '4.0 and above': _Translation(
    '4.0 dan ke atas',
    '4.0 及以上',
    '4.0以上',
    '4.0 이상',
  ),
  '4.5 and above': _Translation(
    '4.5 dan ke atas',
    '4.5 及以上',
    '4.5以上',
    '4.5 이상',
  ),
  'Only show attractions currently open': _Translation(
    'Hanya paparkan tarikan yang sedang dibuka',
    '仅显示当前开放的景点',
    '現在営業中の観光地のみ表示',
    '현재 운영 중인 관광지만 표시',
  ),
  'Apply Filters': _Translation('Guna penapis', '应用筛选', 'フィルターを適用', '필터 적용'),
  'Clear Filters': _Translation(
    'Kosongkan penapis',
    '筛选を清除',
    'フィルターをクリア',
    '필터 지우기',
  ),
  'You can compare up to three attractions.': _Translation(
    'Anda boleh membandingkan sehingga tiga tarikan.',
    '最多可比较三个景点。',
    '最大3つの観光地を比較できます。',
    '최대 세 곳의 관광지를 비교할 수 있습니다.',
  ),
  'Free entry': _Translation('Masuk percuma', '免费入场', '入場無料', '무료 입장'),
  'Distance unavailable': _Translation(
  ...
  'Use 8 or more characters, including uppercase, lowercase, and a number.':
      _Translation(
        'Gunakan 8 atau lebih aksara, termasuk huruf besar, huruf kecil dan nombor.',
        '使用至少 8 个字符，包括大写字母、小写字母和数字。',
        '大文字・小文字・数字を含む8文字以上を使用してください。',
        '대문자, 소문자, 숫자를 포함해 8자 이상 사용하세요.',
      ),
  'Include an uppercase letter, lowercase letter, and number.': _Translation(
    'Sertakan huruf besar, huruf kecil dan nombor.',
    '请包含大写字母、小写字母和数字。',
    '大文字・小文字・数字を含めてください。',
    '대문자, 소문자, 숫자를 포함하세요.',
  ),
