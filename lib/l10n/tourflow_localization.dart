...
const _translations = <String, _Translation>{
  ...
  'Search attractions': _Translation('Cari tarikan', '搜索景点', '観光地を検索', '관광지 검색'),
  'Retry loading home': _Translation('Cuba muat semula halaman utama', '重新加载首页', 'ホームを再読み込み', '홈 다시 불러오기'),
  'Explore Penang': _Translation('Terokai Pulau Pinang', '探索槟城', 'ペナンを探索', '페낭 둘러보기'),
  'Near': _Translation('Berdekatan', '靠近', '付近', '근처'),
  'Where will you go next?': _Translation('Ke manakah anda seterusnya?', '下一站想去哪里？', '次はどこへ行きますか？', '다음에는 어디로 갈까요?'),
  'Search attractions and locations': _Translation('Cari tarikan dan lokasi', '搜索景点和地点', '観光地と場所を検索', '관광지와 장소 검색'),
  'Recommended for you': _Translation('Disyorkan untuk anda', '为你推荐', 'あなたへのおすすめ', '추천 관광지'),
  'Based on your preferences, visits and budget': _Translation('Berdasarkan pilihan, lawatan dan bajet anda', '根据你的偏好、访问记录和预算', '好み、訪問履歴、予算に基づく', '선호도, 방문 기록 및 예산 기준'),
  'Highly rated': _Translation('Dinilai tinggi', '高评分景点', '高評価', '높은 평점'),
  'Aggregate ratings from completed visits': _Translation('Penilaian daripada lawatan yang selesai', '来自已完成访问的综合评分', '完了した訪問の総合評価', '완료된 방문의 종합 평점'),
  'Quieter choices': _Translation('Pilihan lebih tenang', '较少拥挤的选择', 'より静かな選択肢', '한산한 선택지'),
  'Lower live crowd with future slots': _Translation('Orang ramai lebih rendah dengan slot akan datang', '人流较少且有未来时段', '混雑が少なく今後の時間枠がある', '혼잡도가 낮고 향후 시간대가 있는 곳'),
  'Plan or discover an itinerary': _Translation('Rancang atau terokai itinerari', '规划或探索行程', '旅程を計画または探索', '일정 계획 또는 탐색'),
  'No matching attractions available yet.': _Translation('Tiada tarikan sepadan buat masa ini.', '暂时没有匹配的景点。', '一致する観光地はまだありません。', '일치하는 관광지가 아직 없습니다.'),
  'inside': _Translation('di dalam', '园内', '場内', '내부'),
  'Clear search': _Translation('Kosongkan carian', '清除搜索', '検索をクリア', '검색 지우기'),
  'Filters': _Translation('Penapis', '筛选', 'フィルター', '필터'),
  'Filters active': _Translation('Penapis aktif', '筛选已启用', 'フィルター適用中', '필터 적용 중'),
  'Sort': _Translation('Isih', '排序', '並べ替え', '정렬'),
  'Sorted by': _Translation('Disusun mengikut', '排序方式', '並べ替え', '정렬 기준'),
  'Distance origin': _Translation('Asal jarak', '距离起点', '距離の基準地点', '거리 기준 위치'),
  'Using': _Translation('Menggunakan', '使用', '使用中', '사용 중'),
  'No approved attractions match your current search or filters.': _Translation('Tiada tarikan diluluskan sepadan dengan carian atau penapis anda.', '没有已批准景点符合你的搜索或筛选条件。', '検索またはフィルターに一致する承認済み観光地はありません。', '현재 검색 또는 필터와 일치하는 승인된 관광지가 없습니다.'),
  'List View': _Translation('Paparan senarai', '列表视图', 'リスト表示', '목록 보기'),
  'Map View': _Translation('Paparan peta', '地图视图', '地図表示', '지도 보기'),
  'attraction found': _Translation('tarikan ditemui', '个景点', '件の観光地', '개 관광지'),
  'attractions found': _Translation('tarikan ditemui', '个景点', '件の観光地', '개 관광지'),
  'Compare': _Translation('Bandingkan', '比较', '比較', '비교'),
  'Sort Attractions': _Translation('Isih tarikan', '排序景点', '観光地を並べ替え', '관광지 정렬'),
  'Discovery Filters': _Translation('Penapis penerokaan', '发现筛选', '観光地フィルター', '탐색 필터'),
  'Maximum price': _Translation('Harga maksimum', '最高价格', '最高価格', '최대 가격'),
  'Any price': _Translation('Sebarang harga', '任何价格', 'すべての価格', '모든 가격'),
  'Up to RM10': _Translation('Sehingga RM10', '最高 RM10', 'RM10まで', 'RM10 이하'),
  'Up to RM25': _Translation('Sehingga RM25', '最高 RM25', 'RM25まで', 'RM25 이하'),
  'Up to RM50': _Translation('Sehingga RM50', '最高 RM50', 'RM50まで', 'RM50 이하'),
  'Maximum distance': _Translation('Jarak maksimum', '最大距离', '最大距離', '최대 거리'),
  'Any distance': _Translation('Sebarang jarak', '任何距离', 'すべての距離', '모든 거리'),
  'Within 3 km': _Translation('Dalam 3 km', '3 公里以内', '3 km以内', '3km 이내'),
  'Within 10 km': _Translation('Dalam 10 km', '10 公里以内', '10 km以内', '10km 이내'),
  'Within 25 km': _Translation('Dalam 25 km', '25 公里以内', '25 km以内', '25km 이내'),
  'Live crowd': _Translation('Orang ramai semasa', '实时人流', '現在の混雑', '실시간 혼잡'),
  'Any crowd level': _Translation('Sebarang tahap orang ramai', '任何人流等级', 'すべての混雑度', '모든 혼잡도'),
  'Low': _Translation('Rendah', '低', '低い', '낮음'),
  'Moderate': _Translation('Sederhana', '中等', '普通', '보통'),
  'High': _Translation('Tinggi', '高', '高い', '높음'),
  'Minimum visitor rating': _Translation('Penilaian minimum pelawat', '最低访客评分', '最低訪問者評価', '최소 방문객 평점'),
  'Any rating': _Translation('Sebarang penilaian', '任何评分', 'すべての評価', '모든 평점'),
  '3.0 and above': _Translation('3.0 dan ke atas', '3.0 及以上', '3.0以上', '3.0 이상'),
  '4.0 and above': _Translation('4.0 dan ke atas', '4.0 及以上', '4.0以上', '4.0 이상'),
  '4.5 and above': _Translation('4.5 dan ke atas', '4.5 及以上', '4.5以上', '4.5 이상'),
  'Open now': _Translation('Buka sekarang', '现在开放', '現在営業中', '현재 운영 중'),
  'Only show attractions currently open': _Translation('Hanya paparkan tarikan yang sedang dibuka', '仅显示当前开放的景点', '現在営業中の観光地のみ表示', '현재 운영 중인 관광지만 표시'),
  'Apply Filters': _Translation('Guna penapis', '应用筛选', 'フィルターを適用', '필터 적용'),
  'Clear Filters': _Translation('Kosongkan penapis', '筛选を清除', 'フィルターをクリア', '필터 지우기'),
  'You can compare up to three attractions.': _Translation('Anda boleh membandingkan sehingga tiga tarikan.', '最多可比较三个景点。', '最大3つの観光地を比較できます。', '최대 세 곳의 관광지를 비교할 수 있습니다.'),
  'Free entry': _Translation('Masuk percuma', '免费入场', '入場無料', '무료 입장'),
  'Distance unavailable': _Translation('Jarak tidak tersedia', '距离不可用', '距離を取得できません', '거리 정보를 사용할 수 없습니다'),
  'slots': _Translation('slot', '个时段', '件の時間枠', '개의 시간대'),
  'Could not load approved attractions.': _Translation('Tidak dapat memuatkan tarikan yang diluluskan.', '无法加载已批准的景点。', '承認済み観光地を読み込めませんでした。', '승인된 관광지를 불러올 수 없습니다.'),
  'Use 8 or more characters, including uppercase, lowercase, and a number.': _Translation('Gunakan 8 atau lebih aksara, termasuk huruf besar, huruf kecil dan nombor.', '使用至少 8 个字符，包括大写字母、小写字母和数字。', '大文字・小文字・数字を含む8文字以上を使用してください。', '대문자, 소문자, 숫자를 포함해 8자 이상 사용하세요.'),
  'Include an uppercase letter, lowercase letter, and number.': _Translation('Sertakan huruf besar, huruf kecil dan nombor.', '请包含大写字母、小写字母和数字。', '大文字・小文字・数字を含めてください。', '대문자, 소문자, 숫자를 포함하세요.'),
};
