...
class _AdminGenerateReportPageState
    extends State<AdminGenerateReportPage> {
  ...
  Future<void> _pickSustainabilityEndDate() async {
    final date = await _pickDate(
      initialDate:
      _sustainabilityEndDate ??
          _sustainabilityStartDate,
      firstDate:
      _sustainabilityStartDate ??
          DateTime(2020),
      ...
      child: Column(
        ...
        children: [
          ...
          _ReportCard(
            ...
            subtitle:
            'Environmental performance and resource savings',
            metrics: const [
              _MetricItem(
            ...
            _sustainabilityEndDate,
            onStartDate:
            _pickSustainabilityStartDate,
            onEndDate:
            _pickSustainabilityEndDate,
            onGenerate:
            _generateSustainabilityReport,
          ),
          ...
          _ReportCard(
            ...
            'Performance Report',
            subtitle:
            'Visitor satisfaction, rating and revenue analytics',
            metrics: const [
              _MetricItem(
                icon:
            ...
            _performanceEndDate,
            onStartDate:
            _pickPerformanceStartDate,
            onEndDate:
            _pickPerformanceEndDate,
            onGenerate:
